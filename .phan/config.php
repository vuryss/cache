 ...
 * - Look at 'plugins' and add or remove plugins if appropriate (see
 * https://github.com/phan/phan/tree/master/.phan/plugins#plugins)
...
return [
    ...
    // or to indicate a preference for non-nullable types over nullable types)
    //
    // This setting affects the analysis of return statements in the body of the method and the return types passed in
    // by callers.
    ...
    // (E.g. `@return the|null` will still look for a class with the name `the`, but `@return the` will be ignored with
    // the below setting)
    //
